...
Skip any one and the chain breaks. You can have the best runtime logging in the world and still fail an examiner conversation because you don't have the documentation pack. You can have an immaculate model card and lose a CFPB inquiry because your runtime capture can't reconstruct individual decisions.
...
The full SR 11-7 framework that drove the architecture is in the [SR 11-7 whitepaper](/sr117). The FDA Q-Sub equivalent for healthcare is in the [FDA whitepaper](/fda). Both are free and both are written for the model risk officers and clinical AI leads who actually read them.
